    ...
    <Layouts>
            ...
            <div className="col-lg-4 col-xl-3 mil-mb-120">
              <div className="mil-mb-60">
                ...
                <Link href="contact" className="mil-link mil-link-sm">
                  <span>Support Now at +91-8640074511</span>
              ...
              <div className="mil-mb-60">
                ...
                <p>
                  ...
                  Customer Care at support@cevral.com.
                </p>
              </div>
              <div className="mil-mb-60">
                <div className="mil-icon-frame mil-icon-frame-md mil-icon-bg mil-mb-30">
                ...
                <p>
                  Please write us at sales@cevral.com.
                </p>
              </div>
              <div className="mil-divider mil-mb-60" />
      ...
      <div>
        <div className="mil-map-frame">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d222.4459418604702!2d75.79827890237821!3d26.867449419875022!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sin!4v1697190970004!5m2!1sen!2sin"
            width={600}
            height={450}
            style={{ border: 0 }}
            allowFullScreen
          ...
          <div className="row">
            <div className="col-xl-12">
              <div className="mil-mb-60">
                ...
                <h5 className="mil-list-title mil-mb-15">Jaipur</h5>
                <p className="mil-mb-30">
                  Pratap Nagar Scheme 3, Glass Factory Road
                </p>
                <div className="mil-divider mil-divider-left mil-mb-30" />
                <h6 className="mil-mb-15">
                  <span className="mil-accent">+ 91</span> 8640074511
                </h6>
                <h6>
                  <span className="mil-accent">india</span>.support@cevral.com
                </h6>
              </div>
            </div>
