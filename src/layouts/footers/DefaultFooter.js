  ...
  return (
    <footer className="mil-dark-bg">
        ...
        <div className="mil-footer-content mil-p-120-90">
          <div className="row justify-content-between align-items-center">
            <div className="col-xl-4 mil-mb-30">
              ...
              cevral: Where Innovation Meets Excellence. We're dedicated to empowering businesses through cutting-edge technology, tailored solutions, and unwavering commitment. Partner with us to unlock your full potential and thrive in the ever-evolving digital landscape.
              </p>
              ...
              <div className="row">
                <div className="col-lg-7 mil-mb-30">
                  <h3 className="mil-light mil-up-font mil-mb-30">
                    Join The <span className="mil-accent">cevral</span> <br />
                    Experience
                  </h3>
                  <p className="mil-light-soft">
                  At our core, we believe in leveraging technology
                    <br />   to drive growth and unlock new opportunities for our clients.
                  </p>
                </div>
      ...
      <div className="mil-footer-bottom">
        <div className="container">
          <p className="mil-text-sm mil-light">© cevral 2023.</p>
